...
public class WifiEnabler implements CompoundButton.OnCheckedChangeListener  {
    ...
    public static String WIFI_LOCK = "csr_wifi_lock";
    ...
    // from AirplaneModeEnabler
    public static boolean isAirplaneModeOn(Context context) {
        return Settings.Global.getInt(context.getContentResolver(),
                Settings.Global.AIRPLANE_MODE_ON, 0) != 0;
    }

    // from WirelessSettings
    public static boolean isRadioAllowed(Context context, String type) {
        ...
        String toggleable = Settings.Global.getString(context.getContentResolver(),
                Settings.Global.AIRPLANE_MODE_RADIOS); // CHECK: AIRPLANE_MODE_TOGGLEABLE_RADIOS
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        if (isChecked && ((wifiApState == WifiManager.WIFI_STATE_ENABLING) ||
